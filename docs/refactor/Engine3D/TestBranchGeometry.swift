...
class TestBranchGeometry {
    ...
    func updateGeometry(from startNode: TestSceneNode, to endNode: TestSceneNode) {
    ...
    private func generateBranch(from start: SIMD3<Float>, to end: SIMD3<Float>) {
        ...
        let rotationMatrix = simd_float4x4(rotationAxis: rotationAxis, angle: rotationAngle)
